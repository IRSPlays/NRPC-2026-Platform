...
import { LayoutDashboard, Users, FileText, Calculator, Trophy, Database, LogOut, Megaphone, Terminal, Video, MessageSquare } from 'lucide-react';
...
export default function Admin() {
  ...
  const navItems = [
    ...
    { path: '/admin/tickets', label: 'Signal.Log', icon: MessageSquare, adminOnly: false },
